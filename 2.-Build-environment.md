...
`Dockerfile` is [located](https://github.com/andronixapp/termux-packages/blob/master/scripts/Dockerfile)
...
There is a [Vagrantfile](https://github.com/andronixapp/termux-packages/blob/master/scripts/Vagrantfile)
